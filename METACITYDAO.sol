...
contract METACITYDAO is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0xb1B7C4f8C88787C4b65bAf27a866be0FBDd54773)); // MarketingWallet
    ...
    constructor() ERC20("Meta City Dao", "METACITY") {
